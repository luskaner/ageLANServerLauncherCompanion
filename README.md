...
#4376980=Age of Empires II: DE - The Viking Sagas
# Animated Icons
...
*Note: Up-to-date as of 22/09/2026 and using release `Release 2026 09 16 (2) (VS26 FIX)`*.
</details>
...
3. Create `steam_settings\achievements.json` with notepad and copy the following text as-is:
```json
[{"name": "EVERY_MOMENT_I_LIVE_IS_AGONY"}, {"name": "IMPERIAL_AGE"}, {"name": "ALLIANCE"}, {"name": "COMFORTS_OF_HOME"}, {"name": "CARTOGRAPHER"}, {"name": "RAISING_CONQUERORS"}, {"name": "A_PIRATES_LIFE_FOR_ME"}, {"name": "WHAT_A_BEAUTIFUL_CITY"}, {"name": "WINNER_WINNER"}, {"name": "TRADES_MASTER"}, {"name": "ANIMAL_HUNTER"}, {"name": "TREASURE_HUNTER"}, {"name": "BUDGET_CUT"}, {"name": "CONGREVE_ROCKETS"}, {"name": "FULL_OF_HOT_AIR"}, {"name": "BLOOD_ICE_AND_STEEL"}, {"name": "THE_TOMMYNATOR"}, {"name": "FIRE_AND_SHADOW"}, {"name": "THE_ASIAN_DYNASTIES"}, {"name": "SAFARI"}, {"name": "INFLUENCER"}, {"name": "SOCIAL_DOMINANCE"}, {"name": "DANCE"}, {"name": "MEXICAN_VICTORY"}, {"name": "DEVOUT_LEARNER"}, {"name": "TO_THE_SEAS"}, {"name": "MY_HERO"}, {"name": "MALTESE_VICTORY"}, {"name": "STRIKE"}, {"name": "ITALIAN_VICTORY"}, {"name": "GUERRILLEROS_MEXICANOS"}, {"name": "TECHNOLOGICAL_BOOM"}, {"name": "RIBAULDEQUIN"}, {"name": "CASH_COW"}, {"name": "BERSAGLIERI_BATTALION"}, {"name": "ETHIOPIAN_VICTORY"}, {"name": "ELEPHANT_IN_THE_ROOM"}, {"name": "THE_GREAT_SIEGE"}, {"name": "ESTADOS_UNIDOS_MEXICANOS"}, {"name": "HEAVY_METAL_RAIN"}, {"name": "HAUSA_VICTORY"}, {"name": "HERE_COMES_THE_CAVALRY"}, {"name": "INVESTMANT_BANKER"}, {"name": "INTERNATIONAL_SUPPORTERS"}, {"name": "TONGUES_OF_EUROPE"}, {"name": "STRENGTH_IN_NUMBERS"}, {"name": "KNIGHTS_HOSPITAL"}, {"name": "HOLY_MOUNTAINS"}, {"name": "WELL_STUDIED"}, {"name": "DESPERADO"}, {"name": "SEE_MY_VEST"}, {"name": "DEMOLITION_DERBY"}, {"name": "COMPANIA_FUSILEROS"}, {"name": "WONDERS"}, {"name": "BUSINESS_TRIP"}, {"name": "BIG_BOMBARDMENT"}, {"name": "FAITH"}, {"name": "RIDERS"}, {"name": "CONTENT_CREATOR"}, {"name": "BIG_BROTHERS"}, {"name": "LA_SERENISSIMA"}, {"name": "FREE_REAL_ESTATE"}, {"name": "TRULY_REVOLTING"}, {"name": "SHELL_WITH_YOUR_NAME_ON_IT"}, {"name": "PIKE_AND_SHOT"}, {"name": "ECONOMIC_SUPER_POWER"}, {"name": "FIERCE_CAVALRYMEN_OF_TARTARS"}, {"name": "WAR_WAGONS"}, {"name": "KING_OF_KINGS"}, {"name": "RULER_OF_THE_SEVEN_KINGDOMS"}, {"name": "OLD_FASHIONED"}, {"name": "CATHEDRAL_ASSIST"}, {"name": "DEFENSE_OF_THE_HEADQUARTERS"}, {"name": "RAIDING_PARTY"}, {"name": "WHATEVER_THE_PRICE_ILL_BEAT_IT"}, {"name": "WE_NEED_MORE_WOOD"}, {"name": "GRAND_EXCHANGE"}, {"name": "OK_BOOMER"}, {"name": "UPHILL_BATTLE"}, {"name": "SCORCHED_EARTH"}, {"name": "COSSACK_CAPTAIN"}, {"name": "ALONE_AGAINST_THE_WORLD"}, {"name": "STRATEGIST"}, {"name": "ANIMAL_WHISPERER"}, {"name": "NO_MAINS"}, {"name": "IMPERIUM"}, {"name": "MEXICAN_STATESMAN"}, {"name": "WEALTH_OF_EMPIRES"}, {"name": "POLISH_VICTORY"}, {"name": "DANISH_VICTORY"}, {"name": "FINAL_POLISH"}, {"name": "SEJM_AS_YOU"}, {"name": "ROYAL_SNOW_PATROL"}, {"name": "RZECZPOSPOLITA"}, {"name": "GENERALISSIMO"}, {"name": "WORLD_CONQUEST"}, {"name": "CHECKMATE"}, {"name": "BATTLE_OF_AUSTERLITZ"}, {"name": "BATTLE_OF_WATERLOO"}, {"name": "NAVAL_BATTLE_OF_THE_NILE"}, {"name": "SIEGE_OF_OSTEND"}, {"name": "BATTLE_OF_BORODINO"}, {"name": "BATTLE_OF_PANIPAT"}, {"name": "BATTLE_OF_WAGRAM"}, {"name": "ARCTIC_EXPLORER"}, {"name": "REIGN_OF_THE_DEER"}, {"name": "GROSS_PROFIT"}, {"name": "AGE_ATTACK"}, {"name": "GUILTY_AS_CHARGED"}, {"name": "ICEBNB"}, {"name": "FREEEDOOOOM"}, {"name": "FULLY_WORKING"}, {"name": "CHORAGIEW"}, {"name": "CAVALIER_ATTITUDE"}, {"name": "BALTIC_WAY"}, {"name": "DANNEBRAG"}, {"name": "CUBA_LIBRE"}, {"name": "WING_COMMANDER"}, {"name": "SNAP_SHOT"}, {"name": "ROUND_CHURCH_KICK"}, {"name": "BOW_DOWN"}]
```
4. Create `steam_settings\configs.app.ini` with notepad and copy the following text:
```ini
[app::dlcs]
...
#4308600=Age of Empires III: Definitive Edition - The Baltic Powers
# Expansions
...
*Note: Up-to-date as of 19/09/2026 and using release `release-2025_08_29`*.
</details>
...
unlock_all=0
# Expansion Pass
#4180380=Age of Mythology: Retold - Expansion Pass
# Expansions
#2991170=Age of Mythology: Retold - Immortal Pillars
#2991180=Age of Mythology: Retold - Heavenly Spear
#4197940=Age of Mythology: Retold - Obsidian Mirror
# Gods
#2991190=Age Of Mythology: Retold - New Gods Pack: Freyr
#3398380=Age of Mythology: Retold - New Gods Pack: Demeter
# Cosmetics
#2991160=Age of Mythology: Retold - Legacy Deity Portrait Pack
#4140570=Age of Mythology: Retold - Ultimate Fan Pack
#4197930=Age of Mythology: Retold - Blood & Bones Pack
```
5. Remove the starting `#` for the DLCs **you legally own** and are installed.
6. Create `steam_settings\configs.user.ini` with notepad and copy the following text:
```ini
...
disable_lan_only=1
```
9. Edit [Age LAN Server - Launcher](https://github.com/luskaner/ageLANServer/tree/main/launcher) `resources\config.athens.toml` and set:
   * `[Client]`:
      * `Executable`:  `Drive:\Path\To\steamclient_loader_x64.exe`.
      * `Path`: `Drive:\Path\To\SteamLibrary\steamapps\common\Age of Mythology Retold`

*Note: Up-to-date as of 07/04/2026 and using release `Release 2026_03_28`*.
</details>
